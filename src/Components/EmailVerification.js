...
function EmailVerification({ second_tab }) {
  ...
  const Emailid = localStorage.getItem("companydetails")
    ...
    <div>
      <div class="container-sm pt-3" style={{ width: "40rem" }}>
        ...
        <p>
          ...
          code to <span class="font-weight-bold">{Emailid.email_id}</span>.
        ...
        <div class="card text-left card_custom">
          <div class="card-body">
            ...
            <div class="d-flex flex-row mt-5 otpform">
              <input
                ...
                type="text"
                value={otponedata}
                onChange={(e) => setotponedata(e.target.value)}
              />
              <input
                autocomplete="off"
                class="form-control input_height"
                ...
                type="text"
                value={otptwodata}
                onChange={(e) => setotptwodata(e.target.value)}
              />
              <input
                autocomplete="off"
                class="form-control input_height"
            ...
            <div class="row pt-3">
              <div class="col-sm-4">
                <button class="back_btn" onClick={(e) => second_tab(2)}>
                  Back
                </button>
              </div>
              <div class="col-sm-8">
          ...
          <div class="card-footer pt-3 text-center cardbg">
            ...
            <span className="text_color">{Emailid.email_id}</span>
          </div>
        </div>
      </div>
    </div>
